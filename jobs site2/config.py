...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:password@localhost/job_search_db'
    ...
    MAIL_DEFAULT_SENDER = os.environ.get('MAIL_DEFAULT_SENDER') or 'example@gmail.com'
